...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/3.jpg" alt="ERROR">
        </div>
        ...
        <div class="item">
            <img src="assets/img/11.jpg" alt="Flower">
        </div>
...
<div align="center" STYLE="margin-top: 30px">
    ...
    <button data-scroll-reveal="enter from the bottom after 0.2s"
            id="adminLoginBtn" class="btn btn-success btn-lg">LOGIN
    </button>
</div>
<br>
<!-- <div align="center">
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4><strong>Email: </strong>ABC@TTBU.com</h4>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1"
            ...
            <h2><strong>Connect us on </strong></h2>
            <hr/>
            <div>
